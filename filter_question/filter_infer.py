...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the model directory (e.g., Qwen/Qwen2.5-32B-Instruct or local path)",
    )
    ...
    parser.add_argument(
        "--end_idx", type=int, default=1000, help="End index of the dataset"
    )
    ...
    parser.add_argument(
        ...
        help="Path prefix for the dataset (default: filter_question/data)",
    )
...
if __name__ == "__main__":
    ...
    for i, d in enumerate(dataset):
        ...
        d["formatted_input"] = prompt_template.format(
            context=d["context"], input=d["query"]
        )
