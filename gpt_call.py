...
prompt_template_dict = {
    ...
    "cot-cite": "Question: {question}\n\nContext: {context}\n\nAnswer: {answer}\n\nYour task:\nPlease produce a structured, step-by-step reasoning that references any relevant parts only (without indicating which passages they're from) of the context in quotes (\"\") whenever you use them. Finally, present your final conclusion after \"Final answer:\".",
    "mcts": "Question: {question}\n\nContext: {context}\n\nAnswer: {answer}\n\nYour task:\nPlease adopt a multi-phase approach to thoroughly examine the given context, refining your ideas at each stage. Provide the reasoning details step by step, and don't indicate which passages the references are from. Finally, present your final conclusion after \"Final answer:\".",
}
